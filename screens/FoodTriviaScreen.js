...
const styles = StyleSheet.create({
  ...
  factCard: { backgroundColor: 'rgba(236, 96, 57, 1)', padding: 28, borderRadius: 16},
  quizCard: { backgroundColor: "rgba(246, 202, 94, 1)", padding: 24, borderRadius: 16 },
  iconHeader: { fontSize: 20, fontFamily: 'NunitoBold', color: 'white', marginBottom: 12 },
  factText: { fontSize: 18, fontFamily: 'NunitoMedium', color: 'white', lineHeight: 26 },
  subText: { fontSize: 11, fontFamily: 'NunitoRegular', color: '#999999', marginTop: 16, textAlign: 'right' },
  questionText: { fontSize: 18, fontFamily: 'NunitoSemiBold', color: 'white', marginBottom: 20, lineHeight: 24 },
